...
app.get("/", (request, response) => {
    const selectCommand = "SELECT name, email, age, nickname FROM larissaschmidt_02ma"
...
app.post("/login", (request, response) => {
    ...
    const selectCommand = "SELECT * FROM larissaschmidt_02ma WHERE email =?"
...
app.post("/cadastrar", (request, response) => {
    ...
    const insertCommand = `
        INSERT INTO larissaschmidt_02ma(name, email, age, nickname, password)
        VALUES(?, ?, ?, ?, ?)
    `
